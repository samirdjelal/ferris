...
import static com.samirdjelal.ferris.FerrisIcons.FERRIS_ICON;

public class FerrisProgressBarUi extends BasicProgressBarUI {
    private static final float[] FRACTIONS = {0.5f, 1f};
    private static final Color FERRIS_COLOR_START = new JBColor(new Color(254, 134, 1), new Color(254, 134, 1));
    private static final Color FERRIS_COLOR_END = new JBColor(new Color(255, 143, 20), new Color(255, 143, 20));
    private static final Color[] COLORS = {FERRIS_COLOR_START, FERRIS_COLOR_END};
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new FerrisProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g, JComponent c) {
        ...
        FERRIS_ICON.paintIcon(progressBar, g2d, offset2 - JBUI.scale(10), -JBUI.scale(2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        FERRIS_ICON.paintIcon(progressBar, g2d, amountFull - JBUI.scale(10), -JBUI.scale(2));
